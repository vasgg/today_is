answer = {
    ...
    "days_counter_reply": (
        "This function counts days between provided date and today.\n"
        "Enter your event date:\n\n"
        "<i>preferred format: dd.mm.yyyy</i>"
    ),
    "date_calculator_first_reply": (
        "This function counts days between provided two dates.\n"
    ...
    "geodata_error": "Failed to get location data, please try again",
    ...
    "settings_reply": (
        "In this section you can change you timezone settings by providing your "
